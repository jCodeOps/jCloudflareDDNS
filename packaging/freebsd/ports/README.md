...
This directory contains the jCloudflareDDNS 0.1.1 Ports candidate. It is not a
...
validate it in clean FreeBSD jails with the 0.1.1 distfile preloaded in `DISTDIR`,
