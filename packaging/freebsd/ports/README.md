...
This directory contains the jCloudflareDDNS RC1 Ports candidate. It is not a
...
validate it in clean FreeBSD jails with the RC1 distfile preloaded in `DISTDIR`,
